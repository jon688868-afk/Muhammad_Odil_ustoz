// ┌─────────────────────────────────────────────────────────────┐
// │  İDE – İslam Düşünce Enstitüsü  |  APPLICATION DATA        │
// │                                                             │
...
i18n: {
  "tr": {
    ...
    "hero_sub": "İslam Düşünce Enstitüsü, İslam medeniyetinin entelektüel mirasını araştıran ve geliştiren bağımsız bir vakıf araştırma kuruluşudur.",
    "hero_btn1": "Araştırmalarımız",
    "hero_btn2": "Akademi Programları",
    "stat_researchers": "Araştırmacı",
    "stat_publications": "Yayın",
    "stat_events": "Etkinlik",
    ...
    "section_blog": "Blog & Araştırma Yazıları",
    ...
    "form_invalid_email": "Geçerli bir e-posta adresi girin.",
    "form_success": "Mesajınız başarıyla gönderildi!",
    "footer_rights": "Tüm hakları saklıdır."
  },
  "en": {
    "nav_home": "Home",
    "nav_foundation": "IDE Foundation",
    ...
    "hero_sub": "The Institute of Islamic Thought is an independent foundation that researches and advances the intellectual heritage of Islamic civilization.",
...
news: [
  ...
  },
  {
    ...
    "tag_en": "Academy",
    "tag_ar": "أكاديمية",
    "title": "İDE Akademi Bahar Dönemi Başvuruları Açıldı",
    "title_en": "IDE Academy Spring Term Applications are Open",
    "title_ar": "فتح باب التسجيل لفصل الربيع في أكاديمية IDE",
  ...
  },
  {
    ...
    "summary": "Program, dünya genelinden araştırmacılara İDE bünyesinde çalışma imkânı sunmaktadır.",
    "summary_en": "The program offers researchers from around the world the opportunity to work within IDE.",
    "summary_ar": "يوفر البرنامج للباحثين من جميع أنحاء العالم فرصة العمل ضمن معهد IDE.",
    "date": "28 Aralık 2024",
    "category": "Uluslararası",
    "color": "#2a1a3a",
    "author": "İDE Uluslararası",
    "readTime": "3 dk",
    "featured": false
  },
  {
    ...
    "tag_en": "Research",
    "tag_ar": "بحث",
    "title": "İslam Düşüncesinde Bilgi Teorisi Çalışma Grubu Raporu",
  ...
  },
  {
    ...
    "summary": "Konferansta sunulan 32 tebliğ, İDE Yayınları tarafından kitap olarak basıldı.",
    "summary_en": "32 papers presented at the conference have been published as a book by IDE Publications.",
    "summary_ar": "تم نشر 32 ورقة قدمت في المؤتمر ككتاب من قبل منشورات IDE.",
    "date": "15 Aralık 2024",
    "category": "Etkinlik",
    "color": "#1a2a3a",
    "author": "İDE İletişim",
  ...
  },
  {
    ...
    "summary": "İDE Akademi'nin 2024 Güz dönemi programlarından toplam 156 katılımcı sertifika aldı.",
    "summary_en": "A total of 156 participants received certificates from IDE Academy's Fall 2024 programs.",
    "summary_ar": "حصل 156 مشاركاً على شهادات من برامج أكاديمية IDE لخريف 2024.",
    "date": "1 Aralık 2024",
    "category": "Akademi",
    "color": "#1a3a2a",
    "author": "İDE Akademi",
  ...
  },
  {
    ...
    "summary": "İDE ile IIUM arasında araştırma ve akademik değişim alanında iş birliği anlaşması imzalandı.",
    "summary_en": "A cooperation agreement was signed between IDE and IIUM in research and academic exchange.",
    "summary_ar": "تم توقيع اتفاقية تعاون بين IDE وIIUM في مجال البحث والتبادل الأكاديمي.",
    "date": "25 Kasım 2024",
    "category": "Uluslararası",
    "color": "#2a1a3a",
    "author": "İDE Uluslararası",
  ...
  },
  {
    ...
    "tag_en": "Publication",
    "tag_ar": "منشور",
    "title": "İDE Klasik Metin Serisi: Gazali'nin İhyâ'sı Yeni Çevirisi",
    "title_en": "IDE Classic Text Series: New Translation of Ghazali's Ihya",
  ...
  },
  {
    ...
    "tag_en": "International",
    "tag_ar": "دولي",
    "title": "Londra İslam Araştırmaları Merkezi'nde İDE Sunumu",
    "title_en": "IDE Presentation at London Centre for Islamic Studies",
    "title_ar": "عرض IDE في مركز لندن للدراسات الإسلامية",
    "summary": "İDE Başkanı Prof. Dr. Mustafa Kara, İDE'nin araştırma vizyonunu uluslararası platformda anlattı.",
    "summary_en": "IDE President Prof. Dr. Mustafa Kara presented IDE's research vision on the international platform.",
    "summary_ar": "قدم رئيس IDE الأستاذ الدكتور مصطفى كارا رؤية IDE البحثية على المنصة الدولية.",
    "date": "28 Ekim 2024",
    "category": "Uluslararası",
    "color": "#2a1a3a",
    "author": "İDE Uluslararası",
  ...
  },
  {
    ...
    "tag_en": "Announcement",
    "tag_ar": "إعلان",
    "title": "İDE Kütüphanesi Dijital Arşiv Projesi Başladı",
    "title_en": "IDE Library Digital Archive Project Launched",
    "title_ar": "انطلاق مشروع الأرشيف الرقمي لمكتبة IDE",
  ...
  },
  {
    ...
    "summary": "İDE Yaz Okulu'na bu yıl 14 ülkeden 320 başvuru yapıldı; program 80 katılımcıyla gerçekleştirildi.",
    "summary_en": "IDE Summer School received 320 applications from 14 countries this year; the program was held with 80 participants.",
  ...
  },
  {
    ...
    "tag_en": "Publication",
    "tag_ar": "منشور",
    "title": "İDE Araştırma Raporları Serisi – 2024 Cilt II Yayımlandı",
    "title_en": "IDE Research Reports Series – 2024 Volume II Published",
    "title_ar": "سلسلة تقارير أبحاث IDE – صدور المجلد الثاني 2024",
...
events: [
  ...
  },
  {
    ...
    "location": "İDE Akademi Salonu",
    "time": "13:00 - 18:00",
    "description": "İDE bünyesindeki genç araştırmacıların devam eden projelerini sundukları platform.",
    "description_en": "A platform where young researchers at IDE present their ongoing projects.",
...
publications: [
  ...
  },
  {
    "id": 5,
    "abbr": "İD",
    "title": "İslam Düşüncesinde Epistemoloji",
  ...
  },
  {
    ...
    "author": "İDE Araştırma Birimi",
    "year": "2024",
    "type": "Rapor",
    "desc": "İDE'nin 2024 yılındaki tüm araştırma faaliyetlerinin kapsamlı özeti.",
    "desc_en": "Comprehensive summary of all IDE research activities in 2024.",
    "color": "#1e3a5f",
    "pages": 156,
    "language": "Türkçe / İngilizce",
  ...
  },
  {
    ...
    "author": "İDE Usûl Araştırma Birimi",
    "year": "2024",
    "type": "Sözlük",
...
team: [
  ...
  },
  {
    ...
    "initials": "MA",
    "bio": "İslam felsefesi alanında 25 yıllık deneyime sahip; İDE Akademi'nin kurucu koordinatörü.",
    "bio_en": "Has 25 years of experience in Islamic philosophy; founding coordinator of IDE Academy.",
  ...
  },
  {
    ...
    "dept": "İDE Yayınları",
    "dept_en": "IDE Publications",
    "initials": "MA",
    "bio": "İDE'nin tüm yayınlarının editörlük sürecini yürüten deneyimli yayıncı.",
    "bio_en": "An experienced publisher managing the editorial process of all IDE publications.",
  ...
  },
  {
    ...
    "initials": "BK",
    "bio": "İDE'nin idari süreçleri, etkinlik organizasyonu ve kurumsal iletişimden sorumlu.",
    "bio_en": "Responsible for IDE's administrative processes, event organization and corporate communication.",
...
faq: [
  {
    "q": "İDE Akademi programlarına kimler başvurabilir?",
    "q_en": "Who can apply to IDE Academy programs?",
    "q_ar": "من يمكنه التقدم لبرامج أكاديمية IDE؟",
  ...
  },
  {
    ...
    "a": "İDE programlarının büyük çoğunluğu yüz yüze Ankara'da yürütülmekte olup, bazı programlar hibrit veya tamamen online olarak da sunulmaktadır.",
    "a_en": "Most IDE programs are conducted in-person in Ankara, while some programs are offered in hybrid or fully online formats.",
    "a_ar": "تُقام معظم برامج IDE حضورياً في أنقرة، بينما تُقدم بعض البرامج بصيغة هجينة أو أونلاين بالكامل.",
    "category": "Akademi"
  },
  {
    ...
    "a": "Bu program, yurt dışında akademik çalışmalarını yürüten araştırmacıların belirli bir dönem için İDE bünyesinde çalışmalarını sürdürmesine imkân tanır. Program; ofis imkânı, kütüphane erişimi ve yerel araştırmacılarla iş birliği fırsatı sunmaktadır.",
    "a_en": "This program allows researchers conducting academic work abroad to continue their studies within IDE for a specific period. The program offers office space, library access, and opportunities for collaboration with local researchers.",
    "a_ar": "يتيح هذا البرنامج للباحثين الذين يعملون أكاديمياً في الخارج مواصلة دراساتهم ضمن IDE لفترة محددة. يوفر البرنامج مساحة مكتبية وإمكانية الوصول للمكتبة وفرص التعاون مع الباحثين المحليين.",
    "category": "Uluslararası"
  },
  {
    ...
    "a": "İDE yayınlarının büyük bölümü kurumsal web sitesi üzerinden ücretsiz olarak indirilebilmektedir. Basılı kopyalar ise İDE Yayınları üzerinden temin edilebilir.",
    "a_en": "Most IDE publications can be downloaded for free from the institutional website. Printed copies can be obtained through IDE Publications.",
    "a_ar": "يمكن تحميل معظم منشورات IDE مجاناً من الموقع المؤسسي. يمكن الحصول على النسخ المطبوعة من خلال منشورات IDE.",
    "category": "Yayın"
  },
  {
    "q": "İDE'ye nasıl bağış yapabilirim?",
    "q_en": "How can I donate to IDE?",
    "q_ar": "كيف يمكنني التبرع لـ IDE؟",
    "a": "İDE Vakfı'na banka havalesi, kredi kartı veya kurumsal web sitesi üzerinden online bağış yapabilirsiniz. Bağışlarınız vergi indirimine tabidir.",
    "a_en": "You can donate to IDE Foundation via bank transfer, credit card, or online donation through the institutional website. Donations are tax-deductible.",
    "a_ar": "يمكنك التبرع لمؤسسة IDE عبر التحويل البنكي أو بطاقة الائتمان أو التبرع أونلاين عبر الموقع المؤسسي. التبرعات معفاة من الضرائب.",
    "category": "Genel"
  },
  {
  ...
  },
  {
    ...
    "a": "İDE araştırma projelerine katılım, açık çağrılar ve doğrudan davet yoluyla gerçekleşmektedir. Güncel çağrılar web sitesinde ve sosyal medya hesaplarında duyurulmaktadır.",
    "a_en": "Participation in IDE research projects is through open calls and direct invitation. Current calls are announced on the website and social media accounts.",
    "a_ar": "المشاركة في مشاريع IDE البحثية تتم عبر الدعوات المفتوحة والدعوة المباشرة. يتم الإعلان عن الدعوات الحالية على الموقع وحسابات التواصل الاجتماعي.",
    "category": "Araştırma"
  },
  {
    ...
    "a": "İDE kütüphanesi, araştırmacılara, akademisyenlere ve İDE Akademi katılımcılarına açıktır. Ziyaretçilerin önceden randevu alması gerekmektedir.",
    "a_en": "The IDE library is open to researchers, academics, and IDE Academy participants. Visitors are required to make an appointment in advance.",
    "a_ar": "مكتبة IDE مفتوحة للباحثين والأكاديميين والمشاركين في أكاديمية IDE. يُطلب من الزوار حجز موعد مسبقاً.",
    "category": "Genel"
  },
  {
    ...
    "a": "İDE sertifikaları, vakıf statüsünde verilen katılım ve başarı belgeleridir. Akademik kredi olarak kabul edilmeleri, ilgili üniversitenin değerlendirmesine bağlıdır.",
    "a_en": "IDE certificates are participation and achievement documents issued under foundation status. Their acceptance as academic credits depends on the evaluation of the relevant university.",
    "a_ar": "شهادات IDE هي وثائق مشاركة وإنجاز صادرة تحت صفة المؤسسة. قبولها كأرصدة أكاديمية يعتمد على تقييم الجامعة المعنية.",
    "category": "Akademi"
  },
  {
    "q": "İDE'nin kuruluş amacı nedir?",
    "q_en": "What is the founding purpose of IDE?",
    "q_ar": "ما هو الغرض التأسيسي لـ IDE؟",
    "a": "İDE, İslam düşünce geleneğini bilimsel yöntemlerle araştırmak, bu alanda nitelikli araştırmacılar yetiştirmek ve toplumun entelektüel düzeyini yükseltmeye katkıda bulunmak amacıyla kurulmuştur.",
    "a_en": "IDE was established to research the Islamic intellectual tradition using scientific methods, train qualified researchers in this field, and contribute to raising the intellectual level of society.",
    "a_ar": "تأسس IDE للبحث في التقليد الفكري الإسلامي باستخدام المناهج العلمية، وتدريب باحثين مؤهلين في هذا المجال، والمساهمة في رفع المستوى الفكري للمجتمع.",
    "category": "Genel"
  }
],
...
blogPosts: [
  {
    "id": 1,
    "title": "İslam Düşüncesinde Bilgi ve Hikmet Ayrımı",
...
testimonials: [
  {
    ...
    "quote": "İDE, İslam düşüncesinin çağdaş akademik dünyayla buluşmasında önemli bir köprü görevi görmektedir.",
    "quote_en": "IDE serves as an important bridge connecting Islamic thought with the contemporary academic world.",
    "country": "ABD",
    "emoji": "🇺🇸"
  },
  {
    ...
    "quote": "İDE'nin disiplinlerarası yaklaşımı, İslam araştırmalarında yeni ufuklar açmaktadır.",
    "quote_en": "IDE's interdisciplinary approach opens new horizons in Islamic studies.",
    "country": "İngiltere",
    "emoji": "🇬🇧"
  },
  {
    ...
    "quote": "İslam hukuk çalışmalarında İDE'nin ürettiği eserler, uluslararası akademik camiada takdirle karşılanmaktadır.",
    "quote_en": "IDE's works in Islamic legal studies are welcomed with appreciation in the international academic community.",
    "country": "ABD",
    "emoji": "🇺🇸"
  },
  {
    ...
    "quote": "İDE, İslam medeniyetinin entelektüel mirasını araştırma konusunda Türkiye'nin öncü kurumlarından biridir.",
    "quote_en": "IDE is one of Turkey's leading institutions in researching the intellectual heritage of Islamic civilization.",
    "country": "Türkiye",
    "emoji": "🇹🇷"
  },
  {
    ...
    "quote": "Makâsıd araştırmaları alanında İDE'nin çalışmaları, modern İslam hukuk düşüncesine önemli katkılar sunmaktadır.",
    "quote_en": "IDE's work in the field of maqasid research offers significant contributions to modern Islamic legal thought.",
    "country": "ABD",
    "emoji": "🇺🇸"
  },
  {
    ...
    "quote": "İDE'nin akademi programları, genç araştırmacılar için benzersiz bir eğitim ortamı sağlamaktadır.",
    "quote_en": "IDE's academy programs provide a unique educational environment for young researchers.",
    "country": "Türkiye",
    "emoji": "🇹🇷"
  },
  {
    ...
    "quote": "İDE'nin karşılaştırmalı ahlak çalışmaları, Doğu-Batı diyaloguna değerli bir katkı sunuyor.",
    "quote_en": "IDE's comparative ethics studies offer a valuable contribution to East-West dialogue.",
    "country": "İskoçya",
    "emoji": "🏴󠁧󠁢󠁳󠁣󠁴󠁿"
  },
  {
    ...
    "quote": "İslam bilim tarihi araştırmalarında İDE, uluslararası standartlarda çalışmalar üretmektedir.",
    "quote_en": "IDE produces works at international standards in the research of Islamic science history.",
    "country": "Lübnan",
    "emoji": "🇱🇧"
  }
],
...
gallery: [
  ...
  {
    "id": 2,
    "title": "İDE Akademi Güz Dönemi Mezuniyet Töreni",
    "title_en": "IDE Academy Fall Graduation Ceremony",
    "category": "Akademi",
    "date": "2024-12-01",
    "color": "#1a3a2a",
    "icon": "🎓",
  ...
  {
    "id": 4,
    "title": "İDE Kütüphanesi – Nadir Eserler Koleksiyonu",
    "title_en": "IDE Library – Rare Works Collection",
    "category": "Kurum",
    "date": "2024-09-20",
    "color": "#1e3a5f",
    "icon": "📚",
  ...
  {
    "id": 6,
    "title": "İDE Merkez Binası – Ankara",
    "title_en": "IDE Headquarters – Ankara",
    "category": "Kurum",
    "date": "2024-06-15",
    "color": "#1a2340",
    "icon": "🏛️",
